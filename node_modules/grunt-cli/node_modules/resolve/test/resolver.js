...
test('bar', function (t) {
    ...
    resolve('foo', { basedir : dir + '/bar' }, function (err, res) {
        if (err) t.fail(err);
        t.equal(res, dir + '/bar/node_modules/foo/index_controller.js');
    });
...
test('biz', function (t) {
    ...
    resolve('./grux', { basedir : dir }, function (err, res) {
        if (err) t.fail(err);
        t.equal(res, dir + '/grux/index_controller.js');
    });

    resolve('tiv', { basedir : dir + '/grux' }, function (err, res) {
        if (err) t.fail(err);
        t.equal(res, dir + '/tiv/index_controller.js');
    });
...
test('normalize', function (t) {
    ...
    resolve('../grux', { basedir : dir }, function (err, res) {
        if (err) t.fail(err);
        t.equal(res, dir + '/index_controller.js');
    });
});
